...
% use cleveref to combine multiple equation references
\usepackage[capitalise]{cleveref} 

% use breqn to automatically break long equations over several lines
\usepackage{breqn}

% physics package for partial derivatives
\usepackage{physics}
