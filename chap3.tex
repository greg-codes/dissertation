...
\cref{eqn:mach_properties} can be used to calculate the on-axis density and pressure of the LPC. These parameters are shown in \cref{fig:LPC_on_axis}. Note that due to the $G$ factor (\cref{eqn:G_factor}), the FWHM of the pressure and density is simply the width of the LPC's rectangular block: $L_{med} = 2.032$ mm.
...
\begin{figure}
	...
	\caption{Performance of the HPC.}
	\label{fig:HPC_performance}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=0.75\textwidth]{figures/chap3/HHG-HPCvsLPC.png}
	\caption{comparing the performance of the HPC to the LPC. 800 nm, helium.}
