...
\subsection{Vacuum System Introduction}
...
In this section, we will provide a brief overview each vacuum chamber in the TABLe vacuum system.

\subsubsection{Generation \& Differential Pumping Chambers}

The generation chamber is designed to house the HHG gas nozzle or cell. It is here that the XUV light is created for the ATAS experiments. As such, it must be large enough to house an XYZ translation stage, as well as the neccessary electric and gas line feedthroughs. The turbo pump must be large enough to maintain milliTorr or lower pressures while being subjected to large gas throughputs for the duration of an experiment. The geometry of the chamber must accommodate a range of focal lengths and optical layouts. Viewports were added to help with optical alignment to the HHG interaction region.

We use a differential pumping scheme to reduce the flow of gas from the generation chamber to the other parts of the beamline. 

physical dimensions of the chamber. 10 inch 8-way cross. distance between the center of the chamber (HHG position) and the entrance and exit walls.

The chamber is a standard 6-way 10" ConFlat (CF) cross that has been modified to have four additional 2.5" CF ports. These additional ports are positioned at the corners of the top flange and are directed towards the center of the chamber. 

generation turbo: Oerlikon Leybold Turbovac Mag W 1300 iP.
differential pump turbo: Oerlikon Leybold Turbovac Mag W 400 iP.
...
A 10 mm diameter vacuum aperture is placed at the end of the generation chamber. This size was a compromise between minimizing gas flow and maximizing light transmission. This aperture was designed to be interchangeable for other sizes should experimental needs change in the future.

talk about the expected gas flow here. turbo pump specifications and model. gas throughput calculations.
...
talk about the split optical table design here, since you didn't talk about it in the vacuum section.
