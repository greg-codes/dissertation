...
\textbf{consider moving the spatial-temporal overlap section to the experimental part of the dissertation (not the design part)}. Optics for controlling the pulse energy and delay in the pump arm are discussed, as are techniques for finding spatial and temporal overlap in the interaction chamber.
